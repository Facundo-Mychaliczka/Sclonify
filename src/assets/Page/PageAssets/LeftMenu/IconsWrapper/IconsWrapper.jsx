...
const IconsWrapper = () => {
	...
	return (
		<IconsContainer>
			...
			{/* CONTENEDOR DE TU BIBLIOTECA */}
			<LibraryIconsContainer>
				{/* ICONO Y TEXTO DE "TU BIBLIOTECA" */}
				<IconLibrary menuWidth={widthLeftMenu} onClick={() => dispatch(setLeftMenuToSmall())}>
					<StyledImageLibrary
					...
					<LibraryIconP menuWidth={widthLeftMenu}>Biblioteca</LibraryIconP>
				</IconLibrary>
